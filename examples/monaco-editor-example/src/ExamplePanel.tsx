import { PanelExtensionContext, Topic, MessageEvent } from "@coscene/extension";
...
function ExamplePanel({ context }: { context: PanelExtensionContext }): ReactElement {
  ...
  useLayoutEffect(() => {
    // The render handler is invoked by coScene during playback when your panel needs to render
    ...
    context.onRender = (renderState, done) => {
      ...
      // rendering before the next render call, coScene shows a notification to the user that your panel is delayed.
      //
