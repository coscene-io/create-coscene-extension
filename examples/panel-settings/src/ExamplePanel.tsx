...
function ExamplePanel({ context }: { context: PanelExtensionContext }): ReactElement {
  ...
  // subscriptions.
  useLayoutEffect(() => {
    // The render handler is invoked by coScene during playback when your panel needs
    ...
    context.onRender = (renderState, done) => {
      ...
      // render call, coScene shows a notification to the user that your panel is delayed.  Set the
